    ...
    <section className='section h-full' id='about' ref={ref}>
      ...
      <div className="top-[-3] h-[100%] w-[100%] flex justify-center items-center ml-[17%]">
        <div className='about-title'>
          <div className='w-[100%] h-[100%] text-[180px]'>
            <span className='text-[#ffffff]'>WHO</span>
          </div>
          <div className='w-[100%] h-[100%] text-[130px]'>
            <span>AM I?</span>
          </div>
        </div>
      </div>
      <div class="absolute top-[105%] flex w-full left-[-24%] justify-end items-center">
      ...
      <div className='relative left-[-1%]'>
        ...
        { /* text */ }
          ...
          className='flex-1 pt-[5%]'>
            <h2 className='text-[18px] font-extrabold leading-[0.8] mb-9 lg:text-[62px] tiara-about'>
              Hi, I'm Tiara!
            </h2>
            ...
            <div className='pr-[30%] text-[18px] font-extrabold leading-[1.3] text-white'>
              <p>
